...
**Now:** Shipping an [eight-organ orchestration system](https://github.com/meta-organvm) across <!-- v:total_repos -->149<!-- /v --> repos, <!-- v:total_organs -->10<!-- /v --> orgs, and <!-- v:total_words_short -->7K+<!-- /v --> words of public documentation.
